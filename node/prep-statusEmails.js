...
As for your IPs:
    IP1 out of 20 you have ${d["IP1 /20"]}.
    IP2 out of 24 you have ${d["IP2 /24"]}.
...
-Classroom Team.
  ...
  var mailOptions = {
    from: authEmail.user,
    to: d["Email"],
    cc: ['andrew.anampiu@moringaschool.com','faith.thuita@moringaschool.com','leo.igane@moringaschool.com','joyce.wambui@moringaschool.com'],

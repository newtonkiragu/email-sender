...
As for your IPs:
  IP1 out of 28 you have ${d["IP1 /28"]}.
  IP2 out of 31 you have ${d["IP2 /31"]}.
  IP3 out of 21 you have ${d["IP2 /21"]}.
  IP4 out of 22 you have ${d["IP2 /22"]}.
...
-Classroom Team.
  ...
  var mailOptions = {
    from: authEmail.user,
    to: d["Email"],
    cc: ['brian.marete@moringaschool.com', 'christine.karimi@moringaschool.com', 'joyce.wambui@moringaschool.com', 'andrew.anampiu@moringaschool.com'],
  ...
  transporter.sendMail(mailOptions, function (error, info) {
    if (error) {
      ...
      if (errorFile != -1) { // If the file has been successfully opened
        ...
        fs.appendFile(errFile, n, callback); // Write the string to a file
        ...
        fs.appendFile(errFile, n, callback); // Write the string to a file
        fs.appendFile(errFile, mailOptions['to'], callback); // Write the string to a file
        fs.appendFile(errFile, n, callback); // Write the string to a file
        fs.appendFile(errFile, br, callback); // Write the string to a file
